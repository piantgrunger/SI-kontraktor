...
class m180603_104047_create_view_realisasi_detail extends Migration
{
    ...
    {
       $this->execute("CREATE VIEW [dbo].[vw_realisasi_detail]
as

select no_rab,tgl_rab,d.id_d_rab,kode_pekerjaan,nama_pekerjaan,qty,hari_kerja,(d.total_biaya_material+d.total_biaya_material+d.total_biaya_pekerja) as Total_rp,SUM(isnull(Qty_realisasi,0)) as qty_realisasi,
sum(isnull(hari_kerja_realisasi,0)) as hari_kerja_realisasi,
sum(isnull(total_rp_realisasi,0)) as total_rp_realisasi
...
datediff(day,tgl_aw_realisasi,tgl_ak_realisasi) as hari_kerja_realisasi,(m.total_biaya_material+m.total_biaya_material+m.total_biaya_pekerja) as Total_rp_realisasi  from tb_mt_realisasi  m
