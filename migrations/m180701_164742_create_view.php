...
select mr.id_rab, tgl_ak_realisasi,(dr.total_rab/mr.total_rab)*DATEDIFF(DAY,tgl_aw_realisasi,tgl_ak_realisasi)/dr.hari_kerja*100 as progress from tb_mt_realisasi m
...
from
(
select tgl_ak_realisasi,mr.id_rab,(dr.total_rab/mr.total_rab)*DATEDIFF(DAY,tgl_aw_realisasi,tgl_ak_realisasi)/dr.hari_kerja*100 as progress from tb_mt_realisasi m
left outer join tb_dt_rab dr on dr.id_d_rab=m.id_d_rab
 left outer join tb_mt_rab mr on mr.id_rab=m.id_rab
)realisasi
");
